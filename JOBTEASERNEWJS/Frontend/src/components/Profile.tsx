...
const Profile: React.FC = () => {
  const [firstName, setFirstName] = useState<string>(""/* recuperer les valeurs de la base de donnée*/);
  const [lastName, setLastName] = useState<string>(""/* recuperer les valeurs de la base de donnée*/);
  const [phone, setPhone] = useState<string>(""/* recuperer les valeurs de la base de donnée*/);
  const [gender, setGender] = useState<string>("");
  const [email, setEmail] = useState<string>(""/* recuperer les valeurs de la base de donnée*/);
